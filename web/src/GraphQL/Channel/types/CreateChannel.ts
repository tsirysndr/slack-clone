...
export interface CreateChannel_createChannel_creator_channels_messages {
  ...
  receiver: CreateChannel_createChannel_creator_channels_messages_receiver;
  createdAt: any;
  updatedAt: any;
...
export interface CreateChannel_createChannel_creator_sent_messages {
  ...
  receiver: CreateChannel_createChannel_creator_sent_messages_receiver;
  createdAt: any;
  updatedAt: any;
  channelId: string | null;
}
...
export interface CreateChannel_createChannel_creator_received_messages {
  ...
  receiver: CreateChannel_createChannel_creator_received_messages_receiver;
  createdAt: any;
  updatedAt: any;
  channelId: string | null;
}
...
export interface CreateChannel_createChannel_messages {
  ...
  receiver: CreateChannel_createChannel_messages_receiver;
  createdAt: any;
  updatedAt: any;
  channelId: string | null;
}
