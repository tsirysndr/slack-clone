...
export interface EditChannel_editChannel_creator_channels_messages_channel {
  __typename: "channel";
  id: string;
  name: string;
}
...
export interface EditChannel_editChannel_creator_channels_messages {
  ...
  receiver: EditChannel_editChannel_creator_channels_messages_receiver | null;
  channel: EditChannel_editChannel_creator_channels_messages_channel | null;
  createdAt: any;
  updatedAt: any;
...
export interface EditChannel_editChannel_creator_sent_messages_channel {
  __typename: "channel";
  id: string;
  name: string;
}
...
export interface EditChannel_editChannel_creator_sent_messages {
  ...
  receiver: EditChannel_editChannel_creator_sent_messages_receiver | null;
  channel: EditChannel_editChannel_creator_sent_messages_channel | null;
  createdAt: any;
  updatedAt: any;
  channelId: string | null;
}
...
export interface EditChannel_editChannel_creator_received_messages_channel {
  __typename: "channel";
  id: string;
  name: string;
}
...
export interface EditChannel_editChannel_creator_received_messages {
  ...
  receiver: EditChannel_editChannel_creator_received_messages_receiver | null;
  channel: EditChannel_editChannel_creator_received_messages_channel | null;
  createdAt: any;
  updatedAt: any;
  channelId: string | null;
}
...
export interface EditChannel_editChannel_messages_channel {
  __typename: "channel";
  id: string;
  name: string;
}
...
export interface EditChannel_editChannel_messages {
  ...
  receiver: EditChannel_editChannel_messages_receiver | null;
  channel: EditChannel_editChannel_messages_channel | null;
  createdAt: any;
  updatedAt: any;
  channelId: string | null;
}
